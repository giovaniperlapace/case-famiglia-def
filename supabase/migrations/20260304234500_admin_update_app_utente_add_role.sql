drop function if exists public.admin_update_app_utente(uuid, text, text, text, text, text[]);
drop function if exists public.admin_update_app_utente(uuid, text, text, text, text, text[], public.app_role);
...
grant execute on function public.admin_update_app_utente(uuid, text, text, text, text, public.app_role, text[])
to authenticated;
