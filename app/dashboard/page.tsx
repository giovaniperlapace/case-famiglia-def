...
export default async function DashboardPage() {
  ...
  const { data, error } = await supabase
    ...
    .select(
      "id,submission_id,submitted_at,updated_at,current_status,struttura,nome_della_persona,cognome,tipo_aggiornamento,data_di_nascita,data_uscita,data_decesso,dove_dorme"
    )
