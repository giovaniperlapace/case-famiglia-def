...
const PATOLOGIE_CHECKBOXES = [
  ...
  { label: "Malattie del sistema cardio-circolatorio", key: "patologie_malattie_del_sistema_circolatorio" as const },
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const payload: EditableForm = {
        ...
        patologie_malattie_del_sistema_circolatorio: selectedPatologie.includes("Malattie del sistema cardio-circolatorio") ? "true" : "false",
