    ...
    <main>
      ...
      <EditDataClient
        ...
        initialValues={{
          ...
          in_esecuzione_penale_esterna: data.in_esecuzione_penale_esterna,
          esecuzione_penale_esterna_data_inizio:
            data.esecuzione_penale_esterna_data_inizio,
          esecuzione_penale_esterna_data_fine: data.esecuzione_penale_esterna_data_fine,
