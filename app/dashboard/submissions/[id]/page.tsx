    ...
    <main>
      ...
      <Section
        ...
        fields={[
          ...
          { key: "in_esecuzione_penale_esterna", label: "Esecuzione penale esterna" },
          {
            key: "esecuzione_penale_esterna_data_inizio",
            label: "Data inizio esecuzione penale esterna",
          },
          {
            key: "esecuzione_penale_esterna_data_fine",
            label: "Data fine esecuzione penale esterna",
          },
        ]}
      />
      <div className="card" style={{ marginTop: "1rem" }}>
